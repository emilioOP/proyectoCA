...
public class Jugador {
    ...
    public Jugador(int id, String nombre, String apellido, int edad, int nacionalidad, int clubDeportivo, int estadoFisico, int posicion, int nroCamiseta, int aniosComoJugador, int goles, int atajadas, int sueldoFIFA, int tarjetasAmarillas, int tarjetasRojas, boolean titular, boolean habilitado) {
        this.id = id;
        this.nombre = nombre;
